...
const userSchema = mongoose.Schema(
  {
    ...
    // employee = restricted access, designer = limited access to moodboards and
    // products, referrer = partner referral dashboard access)
    role: {
      type: String,
      enum: ["user", "admin", "employee", "designer", "referrer"],
      default: "user",
    },
