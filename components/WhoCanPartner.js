          ...
          <div className="space-y-6 sm:space-y-8">
            ...
            <ul className="space-y-2 sm:space-y-4">
              <li className="flex gap-x-3">
                <span className="mt-0.5 flex size-5 items-center justify-center rounded-full bg-blue-50 text-blue-600">
                  <svg
              ...
              <li className="flex gap-x-3">
                ...
                <div className="grow">
                  <span className="text-sm text-gray-500 sm:text-base">
                    Really anyone with a network or domestic clients that want
                    to introduce us to their friends or family.
                  </span>
                </div>
              </li>
            </ul>
