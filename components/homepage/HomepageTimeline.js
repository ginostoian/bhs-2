const HomepageTimeline = ({ steps }) => {
  return (
    <section className="mx-auto max-w-[88%] px-4 py-10 sm:px-6 lg:px-8 lg:py-14">
      <div className="overflow-hidden rounded-2xl bg-[#202925] px-6 py-10 text-white md:px-10 lg:px-12 lg:py-14">
        <div className="max-w-3xl">
          <p className="mb-3 text-sm font-medium uppercase tracking-[0.24em] text-[#8fb6ff]">
            Process
          </p>
        ...
        <div className="mt-10 grid gap-4 lg:grid-cols-5">
          {steps.map((step, index) => (
            ...
            >
              <p className="text-sm font-medium uppercase tracking-[0.24em] text-[#9ec1ff]">
                Step {index + 1}
              </p>
