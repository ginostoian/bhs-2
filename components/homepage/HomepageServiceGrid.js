  ...
  return (
    <section className="mx-auto max-w-[88%] px-4 py-10 sm:px-6 lg:px-8 lg:py-14">
      <div className="mx-auto mb-10 max-w-3xl text-center lg:mb-14">
        ...
        <h2 className="text-4xl font-medium text-[#202925] md:text-6xl md:leading-tight">
      ...
      <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
        {services.map((service) => (
          <article
            key={service.title}
            className="group overflow-hidden rounded-2xl border border-[#D8D2C6] bg-white shadow-sm transition duration-200 hover:-translate-y-1 hover:shadow-xl"
          >
            <div className="relative h-[240px] overflow-hidden">
              ...
              />
              <div className="absolute left-4 top-4 rounded-full bg-white/95 px-4 py-2 text-sm font-bold text-[#202925] shadow-sm">
                {service.price}
              </div>
            </div>

            <div className="flex h-full flex-col p-6">
              <h3 className="text-2xl font-medium text-[#202925]">
                {service.title}
              </h3>
              <p className="mt-3 min-h-[56px] text-base leading-7 text-gray-600">
                {service.description}
              </p>
              <p className="mt-4 text-sm font-semibold uppercase tracking-[0.2em] text-[#4D5B4B]">
                {service.kicker}
              </p>
              ...
              <div className="mt-6">
                <Link
                  href={service.href}
                  className="inline-flex items-center gap-2 rounded-full border border-[#D8D2C6] bg-[#f5f9ff] px-5 py-3 text-sm font-bold text-[#4D5B4B] transition hover:border-[#4D5B4B] hover:bg-[#4D5B4B] hover:text-white"
                >
                  Explore service
                  <svg
