  ...
  return (
    <aside className="mx-auto max-w-[88%] px-4 py-6 sm:px-6 lg:px-8 lg:py-8">
      <div className="rounded-2xl border border-[#d9e5fb] bg-[#f8fbff] p-6 md:p-8">
        <h2 className="text-2xl font-medium text-[#202925]">{title}</h2>
        ...
        <div className="mt-5 flex flex-wrap gap-3">
          {links.map((link) => (
            <a
              ...
              className="inline-flex min-h-11 items-center gap-2 rounded-full border border-[#D8D2C6] bg-white px-5 text-sm font-bold text-[#4D5B4B] transition hover:border-[#4D5B4B] hover:text-[#3E4A3C]"
            >
              {link.label}
