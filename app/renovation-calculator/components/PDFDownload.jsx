...
export default function PDFDownload({ calculationResult, formData }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await publicFormFetch("/api/renovation-calculator-leads", {
        method: "POST",
      ...
      <div className="grid gap-5 lg:grid-cols-[1.1fr_1fr] lg:items-start">
        <div>
          ...
          <p className="mt-2 text-sm text-stone-600">
            We&apos;ll save your renovation estimate and email a PDF with the
            cost breakdown, assumptions, and practical budgeting guidance.
          </p>
          ...
          <div className="mt-4 rounded-xl border border-stone-200 bg-stone-50 p-4">
            ...
            <ul className="mt-2 space-y-1 text-sm text-stone-700">
              ...
              <li>Line-item breakdown by scope category</li>
              <li>Timeline and assumptions checklist</li>
              <li>Useful next steps before requesting quotes</li>
            </ul>
          </div>
        </div>
