...
/**
 * Employee NotificationBell Component
 *
 * Features:
 * - Real-time notification display for employees
 * - Polls every 5 minutes when tab is visible
 * - Shows employee-specific notification types
 * - Optimized for employee workflow
 */
const NotificationBell = () => {
  ...
  // Get icon for employee notification type
  ...
  // Poll for new notifications every 3 minutes, only when tab is visible
  useEffect(() => {
    let interval;
          ...
          <div className="flex items-center justify-between border-b border-gray-200 p-4">
            <div>
              ...
              <p className="mt-1 text-xs text-gray-500">
                Task updates and project alerts
              </p>
            </div>
            {unreadCount > 0 && (
              <button
