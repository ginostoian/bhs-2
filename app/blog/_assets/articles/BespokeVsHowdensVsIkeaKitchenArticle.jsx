...
export default function BespokeVsHowdensVsIkeaKitchen() {
  return (
    <article className={styles.article}>
      ...
      <p className={styles.p}>
        This is why the same kitchen "from £5,000" is a genuinely different project in Hackney than in a 1990s semi elsewhere. It is also why a fixed-price contract with one team matters more in London than almost anywhere: the borough-specific friction is precisely the part that spirals when responsibility is split across a supplier, a fitter, and whoever handles the leasehold paperwork. If your kitchen is part of a wider project, see our <Link className={styles.inlineLink} href="/blog/home-renovation-cost-london-2026">home renovation cost guide</Link> plus our <Link className={styles.inlineLink} href="/locations/hackney">Hackney</Link> and <Link className={styles.inlineLink} href="/locations/islington">Islington</Link> renovation guides for borough-level detail.
      </p>
      <figure className={styles.figure}>
        <Image
