...
import DesignerMoodboardsClient from "./components/DesignerMoodboardsClient";

/**
 * Designer Moodboards Page
 * Manages user moodboards with creation and management capabilities
 */
export default async function DesignerMoodboardsPage() {
  ...
  return (
    <div>
      ...
      <DesignerMoodboardsClient moodboards={moodboards} users={users} />
    </div>
  );
}
