...
function SignInForm() {
  ...
  const [isSignUp, setIsSignUp] = useState(isReferrerSignUp);
        ...
        <div className="mt-8 space-y-6">
          ...
          {isReferrerSignUp && (
            <div className="rounded-md border border-emerald-200 bg-emerald-50 px-4 py-3 text-sm text-emerald-800">
              Create your referral account with email and password to get your
              own dashboard, referrals list, and unique share link. New
