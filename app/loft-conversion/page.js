...
export default function Page(){return <ServicePage name="Loft conversions" path="/loft-conversion" title="Space above. A better home below." intro="Create an extra bedroom, a quiet workspace or a generous suite without giving up your garden. Better Homes manages the construction, structure and finishing of London loft conversions, working with your existing drawings or a trusted architect." image="/assets/portfolio/extension-daniel-n19/daniel-home-extension-living-and-kitchen.webp" range="\u00a345,000 to \u00a3130,000+ for larger conversions" timeline="8 to 16 weeks; rooflight projects 4 to 6 weeks" guarantee="10 years for loft workmanship" costs={conversionTypes} scope={["Structural floor and roof work to the engineer’s design", "Staircase installation and connection to the existing landing", "Insulation, rooflights or dormer windows and weatherproofing", "Heating, electrics, plumbing and bathroom fitting within the agreed scope", "Plastering, joinery, decoration and handover checks"]} notes={hiddenCostPoints} faqs={getPageFaqs("loft")} projects={["daniel-n19", "james-n8"]}  />;}
