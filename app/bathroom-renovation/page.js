...
export const metadata = getSEOTags({
  title: "Bathroom Renovation London | Design, Supply & Install | Better Homes Studio",
  description:
    "Premium bathroom renovation services across London, including bathroom design, supply and installation with transparent pricing and guaranteed workmanship.",
  canonicalUrlRelative: "/bathroom-renovation",
  openGraph: {
    title: "Bathroom Renovation London | Better Homes Studio",
    description:
      "Design, supply and installation for high-quality bathroom renovations across London.",
