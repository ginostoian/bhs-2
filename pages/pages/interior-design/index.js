...
const InteriorDesign = () => {
  const { title, titleAccent, subtitle, heroCTA, heroImgUrl } =
    text.interiorDesignPage.heroSection;

  const whyUsSection = text.interiorDesignPage.whyUsSection;

  const { title: whyUsTitle, subtitle: whyUsSubtitle } =
    text.interiorDesignPage.whyUsSectionHeader;

  const { title: whatWeDoSectionTitle, subtitle: whatWeDoSectionSubtitle } =
    text.interiorDesignPage.whatWeDoSection.header;
  ...
  } = text.interiorDesignPage.whatWeDoSection.singleStoreyExtension;
  ...
  } = text.interiorDesignPage.whatWeDoSection.sideReturnExtension;
  ...
  } = text.interiorDesignPage.whatWeDoSection.doubleStoreyExtension;
  ...
  } = text.interiorDesignPage.whatWeDoSection.overStructureExtension;
  ...
  } = text.interiorDesignPage.whatWeDoSection.basementExtension;
  ...
  } = text.interiorDesignPage.whatWeDoSection.loftConversion;
